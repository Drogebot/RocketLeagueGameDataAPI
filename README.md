...
Supports all Rocket League versions up to at least [v2.72](https://www.rocketleague.com/news/rocket-league-patch-notes-v2-72) (2026-08-04). Newer versions should keep working unless Psyonix adds a new `EventType`, `CommandType` or `StatEvent`.
